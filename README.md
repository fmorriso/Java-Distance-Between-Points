...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/java-distance-between-points.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/java-distance-between-points/-/settings/integrations)
